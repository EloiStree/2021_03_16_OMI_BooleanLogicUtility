...
namespace BooleanRegisterUtilityAPI.BSM
{
    ...
    [System.Serializable]
    public abstract class AbstractConditionBoolState 
    {
        protected List<BooleanValueRef> m_observedState;
        protected List<BooleanValueChangeRef> m_observedChange;
        ...
        public abstract  bool IsConditionValide(BooleanStateRegister register);
