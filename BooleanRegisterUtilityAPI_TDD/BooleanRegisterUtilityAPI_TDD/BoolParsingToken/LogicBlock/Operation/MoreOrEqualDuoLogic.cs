...
{
    internal class MoreOrEqualDuoLogic : DoubleLogicBlock
    {
        public MoreOrEqualDuoLogic(LogicBlock left, LogicBlock right) : base(left, right)
        {
        }

        public override bool ComputedBoolean(bool vl, bool vr)
        {
            return BoolOperationLogic.AMoreOrEqualB(vl, vr);
        }
